 ...
 * distributing a fixed copy of the class would be breaking the license
 * agreement.
 * <p>
 ...
 * 
 * @author Roan
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-4361044">JDK Bug
 *      4361044</a>
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-4523159">JDK Bug
 *      4523159</a>
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-4730642">JDK Bug
 *      4730642</a>
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-6249364">JDK Bug
 *      6249364</a>
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-6390779">JDK Bug
 *      6390779</a>
 * @see <a href="https://bugs.openjdk.java.net/browse/JDK-7188320">JDK Bug
 *      7188320</a>
...
public class ExclamationMarkPath {
    ...
    public static void check(boolean suppressWarning, String... args) {
        if (check()) {
            if (suppressWarning
                    || (args != null && args.length != 0 && args[args.length - 1].equalsIgnoreCase("-relaunch"))) {
