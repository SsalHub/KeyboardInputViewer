...
public class CommandKeys {
    ...
    protected static CMD askForNewKey() {
        ...
        if (Dialog.showSaveDialog(form)) {
            ...
            CMD cmd = new CMD(Main.lastevent.getKeyCode(), Main.lastevent.getKeyLocation(),
                    isAltDown || alt.isSelected(), isCtrlDown || ctrl.isSelected());
