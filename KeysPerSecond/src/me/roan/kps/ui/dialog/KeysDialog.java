...
import me.roan.kps.Configuration;
...
public class KeysDialog{
	...
	public static final void selectKeyMode(){
		...
		customPanel.add(new JLabel(String.format("<html><b>[Default option]</b> You can customize the key setting.</html>")));
		...
		int selection = 0;
		//String[] options = new String[] {"Cusom setting", "*All keys", "*Basic+Arrow keys", "*Basic+Numpad keys"};
	...
	private static void showAddKeyDialog(KeysModel model){
		...
		if(Dialog.showSaveDialog(form)){
			...
			KeyInformation info = new KeyInformation(NativeKeyEvent.getKeyText(Main.lastevent.getKeyCode(), Main.lastevent.getKeyLocation()), Main.lastevent.getKeyCode(), Main.lastevent.getKeyLocation(), (alt.isSelected() || CommandKeys.isAltDown) && Main.config.enableModifiers, (ctrl.isSelected() || CommandKeys.isCtrlDown) && Main.config.enableModifiers, (shift.isSelected() || CommandKeys.isShiftDown) && Main.config.enableModifiers, false);
			...
			if(Dialog.showConfirmDialog("Add the " + info.getModifierString() + info.name.substring(n) + " key?")){
				if(isAddedNumpadKey(info, alt.isSelected(), ctrl.isSelected(), shift.isSelected()) || Main.config.keyinfo.contains(info)){
					KeyInformation.autoIndex -= 2;
	...
	private static boolean isAddedNumpadKey(KeyInformation info, boolean alt, boolean ctrl, boolean shift) {
		...
		switch(info.keycode) {
		// NUMPAD_.
		case 9437267: corrCode = 1052243; break;
		case 1052243: corrCode = 9437267; break;
		// NUMPAD_0
		case 9437195: corrCode = 1052242; break;
		case 1052242: corrCode = 9437195; break;
		// NUMPAD_1
		case 9437186: corrCode = 1052239; break;
		case 1052239: corrCode = 9437186; break;
		// NUMPAD_2
		case 9437187: corrCode = 1106000; break;
		case 1106000: corrCode = 9437187; break;
		// NUMPAD_3
		case 9437188: corrCode = 1052241; break;
		case 1052241: corrCode = 9437188; break;
		// NUMPAD_4
		case 9437189: corrCode = 1105995; break;
		case 1105995: corrCode = 9437189; break;
		// NUMPAD_5
		case 9437190: corrCode = 1105996; break;
		case 1105996: corrCode = 9437190; break;
		// NUMPAD_6
		case 9437191: corrCode = 1105997; break;
		case 1105997: corrCode = 9437191; break;
		// NUMPAD_7
		case 9437192: corrCode = 1052231; break;
		case 1052231: corrCode = 9437192; break;
		// NUMPAD_8
		case 9437193: corrCode = 1105992; break;
		case 1105992: corrCode = 9437193; break;
		// NUMPAD_9
		case 9437194: corrCode = 1052233; break;
		case 1052233: corrCode = 9437194; break;
		default:
			return false;
		}
		for(int i=0; i<Main.config.keyinfo.size(); i++) {
			if(Main.config.keyinfo.get(i).keycode == corrCode) return true;
		}
		return false;
	}
	...
	private static void setAllKeys() {
		...
		for(int[] infoList : allKeyInfoList) {
			KeyInformation info = new KeyInformation(NativeKeyEvent.getKeyText(infoList[0], infoList[1]), infoList[0], infoList[1], (false || CommandKeys.isAltDown) && Main.config.enableModifiers, (false || CommandKeys.isCtrlDown) && Main.config.enableModifiers, (false || CommandKeys.isShiftDown) && Main.config.enableModifiers, false);
		...
		public void setValueAt(Object value, int row, int col){
			...
			case 2:
				if((boolean)value == true){
					Integer code = Main.config.keyinfo.get(row).keycode + Main.config.keyinfo.get(row).keyLocation * 10000000;
